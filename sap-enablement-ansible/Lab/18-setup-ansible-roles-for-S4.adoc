...
- timeserver configurazion (rhel_system_roles.timesync)
- networking setup
- disk configuration (rhel_system_roles.storage)
...
The disk configuration (rhel_system_roles.storage) needs an indivdual or different configuration than SAP HANA. In our lab use the following variables to configure the disk of `s4hana`:
